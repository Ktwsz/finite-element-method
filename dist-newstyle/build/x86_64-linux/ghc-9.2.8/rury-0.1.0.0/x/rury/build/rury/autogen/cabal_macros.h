...
/* package rury-0.1.0.0 */
#ifndef VERSION_rury
#define VERSION_rury "0.1.0.0"
#endif /* VERSION_rury */
#ifndef MIN_VERSION_rury
#define MIN_VERSION_rury(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rury */
...
#define CURRENT_COMPONENT_ID "rury-0.1.0.0-inplace-rury"
